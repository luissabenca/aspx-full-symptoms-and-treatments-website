...
{
    public partial class contatoAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmdSelect = new SqlCommand("SELECT * FROM avaliacao", conexao);
                SqlDataReader resposta = cmdSelect.ExecuteReader();

                while (resposta.Read())
                {
                    printar += "<tr><td>" + resposta.GetInt32(0) + "</td><td>" + resposta.GetDateTime(1) +
                        "</td><td>" + resposta.GetInt32(2) + "</td><td>" + resposta.GetString(3) + "</td></tr>";
                }
